...
$.when($.ready).then(function () {
  ...
  if (sortableEl !== null) {
    ...
    var createSortable = function createSortable(el, options) {
      // eslint-disable-next-line no-undef
      var instance = Sortable.create(el, _objectSpread({
        disabled: true,
        animation: 150,
    ...
    if (sortableEl.classList.contains("categories")) {
      ...
      sortableEl.querySelectorAll(".category").forEach(function (categoryEl) {
        createSortable(categoryEl, {
  ...
  var setSortableDisabled = function setSortableDisabled(disabled) {
    sortables.forEach(function (instance) {
      return instance.option("disabled", disabled);
    });
  };
