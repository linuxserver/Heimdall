...
return [
    ...
    */
    ...
    'accepted'             => ':attribute 必须为接受.',
    'active_url'           => ':attribute 不是一个有效的网址.',
    'after'                => ':attribute 必须在 :date 之后.',
    'after_or_equal'       => ':attribute 必须为 :date 或在其之后.',
    'alpha'                => ':attribute 应仅包含英文字母.',
    'alpha_dash'           => ':attribute 应仅包含英文字母, 数字与"-"符号.',
    'alpha_num'            => ':attribute 应仅包含英文字母与数字.',
    'array'                => ':attribute 必须为一个数组.',
    'before'               => ':attribute 必须在 :date 之前.',
    'before_or_equal'      => ':attribute 必须为 :date 或在其之前.',
    'between'              => [
        'numeric' => ':attribute 必须在 :min - :max 之间.',
        'file'    => ':attribute 必须在 :min - :max 千字节 之间.',
        'string'  => ':attribute 必须在 :min - :max 个字符 之间.',
        'array'   => ':attribute 必须在 :min - :max 个项 之间.',
    ],
    'boolean'              => ':attribute 必须为真或假.',
    'confirmed'            => ':attribute 确认不匹配.',
    'date'                 => ':attribute 为无效日期.',
    'date_format'          => ':attribute 不符合 :format 的格式.',
    'different'            => ':attribute 与 :other 必须不一致.',
    'digits'               => ':attribute 必须为 :digits 位.',
    'digits_between'       => ':attribute 必须在 :min - :max 位 之间.',
    'dimensions'           => ':attribute 图像尺寸无效.',
    'distinct'             => ':attribute 字段有重复值.',
    'email'                => ':attribute 必须为有效的邮箱地址.',
    'exists'               => '选中的 :attribute 已存在.',
    'file'                 => ':attribute 必须为文件.',
    'filled'               => ':attribute 必须填写.',
    'image'                => ':attribute 必须为图片.',
    'in'                   => '选中的 :attribute 无效.',
    'in_array'             => ':attribute 必须不存在于 :other.',
    'integer'              => ':attribute 必须为整数.',
    'ip'                   => ':attribute 必须为 IP 地址.',
    ...
    'required_if'          => ':attribute 字段必须填写, 因 :other 为 :value.',
