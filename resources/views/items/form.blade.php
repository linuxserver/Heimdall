<section class="module-container">
    <header>
        ...
        <div class="module-actions">
            ...
            <button type="submit" class="button"><i class="fa fa-save"></i><span>{{ __('app.buttons.save') }}</span>
            </button>
            <a href="{{ route('items.index', []) }}" class="button"><i
                    class="fa fa-ban"></i><span>{{ __('app.buttons.cancel') }}</span></a>
        </div>
    </header>
    ...
    <div id="tile-preview" class="create">
        ...
        <div class="appoptions">
            <div class="optdetails">
                <div>
                    <button id="optdetails-button" class="dark">{{ __('app.apps.apptype') }}</button>
                </div>
                <div class="optvalue">
                    <div class="input">
                        {!! Form::select('appid', \App\Models\Application::applist(), null, array('class' => 'form-control config-item', 'id' => 'apptype', 'data-config' => 'type')) !!}
                    </div>
                </div>
            </div>
            <div id="searchwebsite" class="optdetails">
                <div>
                    <button class="dark">{{ __('app.apps.website') }}</button>
                </div>
                <div class="optvalue">
                    <div class="input">
    ...
    <div class="create">
        ...
        @if(isset($item) && $item->enhanced())
            ...
            <div id="sapconfig" style="display: block;">
                @if(isset($item))
                    @include('SupportedApps::'.\App\Models\Item::nameFromClass($item->class).'.config')
                @endif
            </div>
